...
# --- 1. IMPORTAMOS LIBRERÍAS EXTERNAS CON SEGURIDAD ---
try:
...
# =========================================================
#  PANTALLA DE ARRANQUE (LA CÁSCARA SEGURA)
# =========================================================
    ...
    def vista_formacion():
        ...
        def btn_pdf_click(e):
            ...
            if ok:
                ...
                btn_ojo.disabled = False; btn_ojo.icon_color = C_AZUL; btn_ojo.url = url_pdf; btn_ojo.update()
            else: txt_estado_app.value = f"❌ Error Gen: {res}"
            page.update()
        ...
        def pdf_click(e):
            try:
                ...
                if ok:
                    ...
                    btn_ojo_mensual.disabled = False; btn_ojo_mensual.icon_color = C_VIOLETA; btn_ojo_mensual.url = url_pdf; btn_ojo_mensual.update()
                else: txt_estado_app.value = f"Error: {res}"
                page.update()
            except: pass
            ...
            for j in lista_jugadoras_raw:
                ...
                def crear_accion_pdf(jug_f, s_f, btn_v_f):
                    def on_gen_click(e):
                        ...
                        if ok:
                            txt_estado_app.value = "✅ Archivo Listo. Click en el ojo."
                            btn_v_f.disabled = False; btn_v_f.icon_color = C_VIOLETA; btn_v_f.url = url_pdf; btn_v_f.update()
                        else: txt_estado_app.value = f"Error: {res}"; page.update()
                    return on_gen_click
